...
<!-- cann-meta
{
  "sidebarTitle": "长序列强化学习训练",
  "quantization": ["bf16"],
  "parallelism": ["data-parallel", "tensor-parallel", "pipeline-parallel", "context-parallel", "expert-parallel"],
  "operator": ["none"],
  "cannFeatures": ["npugraph"],
  "hardware": ["atlas-a3"],
  "frameworks": ["cann-recipes", "megatron"],
  "cover": {"type": "auto"}
}
-->
